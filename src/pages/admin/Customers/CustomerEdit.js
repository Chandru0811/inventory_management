        ...
        <div className="card shadow border-0 my-2">
          ...
          <div className="container mb-5">
            <div className="row py-4">
              ...
              <div className="col-md-6 col-12 mb-2">
                <lable className="form-lable">Account Number</lable>
                <div className="mb-3">
                  <input
                    type="text"
                    name="accNumber"
              ...
              <div className="col-md-6 col-12 mb-2">
                <lable className="form-lable">Primary Contact</lable>
                <div className="mb-3">
                  <input
                    type="text"
                    name="primaryContact"
              ...
              <div className="col-md-6 col-12 mb-2">
                <lable className="form-lable">Customer Email</lable>
                <div className="mb-3">
                  <input
                    type="text"
                    name="email"
              ...
              <div className="col-md-6 col-12 mb-2">
                <lable className="form-lable">Website</lable>
                <div className="mb-3">
                  <input
                    type="text"
                    name="website"
              ...
              <div className="col-md-6 col-12 mb-2">
                <lable className="form-lable">Bank Name</lable>
                <div className="mb-3">
                  <input
                    type="text"
                    name="bankAccName"
              ...
              <div className="col-md-6 col-12 mb-2">
                <lable className="form-lable">Bank Account Number</lable>
                <div className="mb-3">
                  <input
                    type="text"
                    name="bankAccNumber"
              ...
              <div className="container mb-5">
                <div className="row py-4">
                  ...
                  <div className="col-md-6 col-12 mb-2">
                    <label className="form-label">Shipping Attention</label>
                    <div className="mb-3">
                      <input
                        type="text"
                        name="deliAttention"
                        className={`form-control ${
                          formik.touched.deliAttention &&
                  ...
                  <div className="col-md-6 col-12 mb-2">
                    <label className="form-label">Billing Attention</label>
                    <div className="mb-3">
                      <input
                        type="text"
                        name="billAttention"
                        className={`form-control ${
                          formik.touched.billAttention &&
