...
function OrderEdit() {
  ...
  const validationSchema = Yup.object({
    ...
    deliveryAddressCategory: Yup.string().required("*Delivery address category is required"),
    deliveryAddress: Yup.string().required("*Delivery address Date is required"),
            ...
            <div className="row align-items-center">
              <div className="col">
                <div className="d-flex align-items-center gap-4">
                  <h1 className="h4 ls-tight headingColor">Edit Order</h1>
                </div>
              </div>
            ...
            <div className="row py-4">
              <div className="col-md-6 col-12 mb-3">
                ...
                <div className="mb-3">
                  ...
                  {customerData &&
                    customerData.map((vendorName) => (
                      <option key={vendorName.id} value={vendorName.id}>
              ...
              <div className="col-md-6 col-12 mb-3">
                ...
                <div className="mb-3">
                  <input
                    ...
                    {...formik.getFieldProps("deliveryAddressCategory")}
                  />
                  {formik.touched.deliveryAddressCategory &&
                    formik.errors.deliveryAddressCategory && (
                      <div className="invalid-feedback">
              ...
              <div className="col-md-6 col-12 mb-3">
                <lable className="form-lable">
                Purchase Orde rNumber<span className="text-danger">*</span>
                </lable>
                <div className="">
                  <input
                    type="text"
              ...
              <div className="col-md-6 col-12 mb-3">
                ...
                <input
                    type="text"
                    className={`form-control  ${
                      formik.touched.purchaseOrderRef && formik.errors.purchaseOrderRef
                        ? "is-invalid"
                        : ""
                    }`}
              ...
              <div className="col-md-6 col-12 mb-3">
                ...
                <div className="mb-3">
                  <input
                    type="text"
                    className={`form-control  ${
                      formik.touched.shipmentPreference && formik.errors.shipmentPreference
                        ? "is-invalid"
                        : ""
                    }`}
              ...
              <div className="col-md-6 col-12 mb-3">
                ...
                <input
                  ...
                  className="form-control"
                  onChange={(event) => {
                    formik.setFieldValue("purchaseOrderFile", event.target.files[0]);
                  }}
